...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/bike.svg
  SvgGenImage get bike => const SvgGenImage('assets/images/bike.svg');

  /// File path: assets/images/clock.svg
  SvgGenImage get clock => const SvgGenImage('assets/images/clock.svg');

  /// File path: assets/images/location-pin.svg
  SvgGenImage get locationPin =>
      const SvgGenImage('assets/images/location-pin.svg');
